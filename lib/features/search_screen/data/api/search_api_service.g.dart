...
class _SearchApiService implements SearchApiService {
  ...
  @override
  Future<List<ListDoctors>> getSearch() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ListDoctors>>(
    ...
    late List<ListDoctors> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ListDoctors.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
